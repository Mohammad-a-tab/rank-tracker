...
return [
    ...
    */
    ...
    'custom' => [
        'blood_type' => [
            'not_selected' => 'لطفاً یک مورد انتخاب کنید.',
        ],
    ],
    ...
    */
    'attributes' => [
        ...
        "first_name" => "نام",
        "soft_skills" => "مهارت",
        "living_status" => "وضعیت زندگی",
        "family_leader" => "سرپرست خانوار",
        "smoking_status" => "وضعیت سیگار",
        "education_opportunity" => "فرصت آموزش در سازمان",
        "close_friend_mobile" => "شماره دوست نزدیک",
        "education" => "تحصیلات",
        "military_status" => "وضعیت خدمت آقایان",
        "iban_number" => "شماره شبا",
        "account_number" => "شماره حساب",
        "card_number" => "شماره کارت",
        "graduation_date" => "زمان فارغ التحصیلی",
        "education_level" => "آخرین مقطع تحصیلی",
        "parent_name" => "نام والدین",
        "parent_mobile" => "شماره موبایل والدین",
        "spouse_name" => "نام همسر",
        "spouse_mobile" => "شماره موبایل همسر",
        "handedness" => "چپ دست یا راست دست",
        "marital_status" => "وضعیت تاهل",
        "identity_image" => "عکس کارت ملی یا شناسنامه",
        ...
        "city" => "شهر",
        "business_mobile" => "شماره موبایل کاری",
        "sickness" => "بیماری",
        "ex_workplace_info" => "اطلاعات محل کار سابق",
        "referral" => "معرف",
        "other_skills" => "سایر مهارت ها",
        "other_langs" => "سایر زبان ها",
        "country" => "کشور",
        "social_media" => "شبکه های اجتماعی",
        "address" => "نشانی",
        "num_children" => "تعداد فرزند",
        "phone" => "تلفن",
        "mobile" => "تلفن همراه",
        "age" => "سن",
        "url" => "آدرس وبسایت",
